...
pub fn run() {
    tauri::Builder::default()
        .invoke_handler(tauri::generate_handler![
            ...
            commands::library::library_select_pdf_files,
            ...
            commands::library::library_create_category,
            commands::library::library_update_category,
            commands::library::library_move_category,
            commands::library::library_delete_category,
            commands::library::library_list_papers,
            commands::library::library_reorder_papers,
            commands::library::library_import_pdfs,
            commands::library::library_assign_paper_category,
            commands::library::library_update_paper,
            commands::library::library_delete_paper,
