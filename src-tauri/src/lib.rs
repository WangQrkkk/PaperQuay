...
pub fn run() {
    ...
    tauri::Builder::default()
        .invoke_handler(tauri::generate_handler![
            ...
            commands::translation::translate_text_openai_compatible,
            ...
            commands::rag::commands::rag_embed_chunks,
            commands::rag::commands::rag_embed_text,
            commands::rag::commands::rag_get_document_index_status,
            commands::rag::commands::rag_index_document,
            commands::rag::commands::rag_report_document_index_failure,
            commands::rag::commands::rag_retrieve_document_chunks,
