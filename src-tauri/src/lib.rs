...
pub fn run() {
    ...
    tauri::Builder::default()
        .invoke_handler(tauri::generate_handler![
            ...
            commands::webdav_backup::webdav_get_backup_settings,
            commands::webdav_backup::webdav_update_backup_settings,
            commands::webdav_backup::webdav_test_connection,
            commands::webdav_backup::webdav_backup_now,
            commands::webdav_backup::webdav_inspect_latest_backup,
            commands::webdav_backup::webdav_restore_missing_from_latest,
